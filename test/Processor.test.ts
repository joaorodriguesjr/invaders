...
describe('Processor', () => {
  ...
  describe('DCX BC', () => {
    ...
    beforeEach(() => {
      memory.writeByte(0x00, 0x0B)
      processor.BC = value
      repeat(() => processor.clock(), 5)
    })

    it('Should decrement register pair BC by 1', () => {
      expect(processor.BC).toBe(value - 1)
    })
  ...
  describe('DCR C', () => {
    ...
    beforeEach(() => {
      memory.writeByte(0x00, 0x0D)
      processor.C = value
      repeat(() => processor.clock(), 5)
    })

    it('Should decrement register C by 1', () => {
      expect(processor.C).toBe(value - 1)
    })
  ...
  describe('STAX DE', () => {
    ...
    it('Should store accumulator into memory', () => {
      expect(memory.readByte(processor.DE)).toBe(processor.A)
    })
